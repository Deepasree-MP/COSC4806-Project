...
<head>
    ...
    <style>
        ...
        .card, .rating-card {
            background: rgba(18,21,45,0.98) !important;
            color: #f1f7fa !important;
            border-radius: 1.2rem !important;
            box-shadow: 0 2px 16px 0 rgba(120,140,255,0.10), 0 1px 4px 0 rgba(50,60,100,0.23) !important;
        }
        .card .card-title, .rating-card .card-title {
            color: #b4cdff !important;
            font-weight: 600;
            font-size: 1.18rem;
            margin-bottom: .5rem;
        }
        .card:hover, .rating-card:hover, .card:focus, .rating-card:focus {
            transform: translateY(-10px) scale(1.04) rotateZ(-1deg);
            box-shadow: 0 10px 40px 0 rgba(120,140,255,0.30), 0 2px 12px 0 rgba(0,0,0,0.25) !important;
        }
        .container, main, .navbar, .table, .table th, .table td {
            color: #f1f7fa !important;
        ...
        input, textarea, select, .form-control {
            ...
            color: #f1f7fa !important;
            border: 1px solid #6375ab !important;
        }
        ...
        .btn-primary {
            background: #475fff !important;
            border-color: #475fff !important;
        }
        .btn-outline-secondary {
            border-color: #b4cdff !important;
            color: #b4cdff !important;
        }
        .btn-link {
        ...
        .alert-info, .alert-warning, .alert-danger, .alert-success {
            color: #fff !important;
            background: rgba(40,60,120,0.7) !important;
            border: 1px solid #6375ab !important;
        }
        .list-group-item {
            background: rgba(18,21,45,0.97) !important;
            color: #f1f7fa !important;
            border-color: #6375ab !important;
        }
        a, a:visited, a.nav-link {
            color: #97bfff !important;
        }
